...
function ProductCard({ product, onEdit, onDelete }) {
  return (
    <div className="overflow-hidden rounded-(--radius-app) bg-[#F2EBE6] shadow-sm">
      ...
      <div className="grid gap-4 px-8 py-6 md:grid-cols-4">
        <div className="rounded-(--radius-app) bg-white px-5 py-5">
      ...
      <div className="px-8 pb-8">
        ...
        <div className="space-y-3">
          {product.ingredients?.map((item, index) => (
            <div
              key={index}
              className="flex items-center justify-between rounded-(--radius-app) bg-white px-5 py-4"
            >
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-(--radius-app) bg-[#E8CFC8] text-[#5B4636]">
                  <FaEgg />
                </div>
